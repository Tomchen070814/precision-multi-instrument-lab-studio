...
No third-party source files are copied into this branch. Dependencies are
consumed as version-pinned NuGet packages.

| Component | Version | License | Purpose |
|---|---:|---|---|
| CommunityToolkit.Mvvm | 8.4.2 | MIT | observable state and generated commands |
| ScottPlot.WPF | 5.1.59 | MIT | WPF real-time trend rendering |
...
Package licenses and notices distributed by NuGet remain authoritative.
