...
public sealed partial class DataPipeServer : BackgroundService
{
    ...
    {
        LogDataPipeReady(_logger, PipeNames.Data);
        ...
        CancellationToken cancellationToken)
    {
        ...
        using (MeasurementSubscription subscription = _hub.Subscribe())
        {
            ...
            {
                LogDataClientDisconnected(_logger, exception);
            }
        }
    }
    ...
    [LoggerMessage(
        ...
        Message = "Data pipe {PipeName} is ready.")]
    private static partial void LogDataPipeReady(ILogger logger, string pipeName);

    [LoggerMessage(
        EventId = 201,
        Level = LogLevel.Debug,
        Message = "A data-pipe client disconnected.")]
    private static partial void LogDataClientDisconnected(
        ILogger logger,
        Exception exception);
}
